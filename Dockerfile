...
RUN wget -q https://huggingface.co/Kijai/LongCat-Video_comfy/resolve/main/Avatar/LongCat-Avatar_comfy_bf16.safetensors -O /ComfyUI/models/diffusion_models/LongCat-Avatar_comfy_bf16.safetensors
RUN wget -q https://huggingface.co/Kijai/LongCat-Video_comfy/resolve/main/LongCat_distill_lora_alpha64_bf16.safetensors -O /ComfyUI/models/loras/LongCat_distill_lora_alpha64_bf16.safetensors
